...
var Item = exports.Item = function () {
  function Item(id, v) {
    var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
        ...
        edges = _ref$edges === undefined ? 0 : _ref$edges;
  ...
  _createClass(VertexTree, [{
    ...
    value: function insert(id, v) {
      if (id instanceof Item) {
        _insert2(this._node, id);
      } else {
        _insert2(this._node, new Item(id, v));
      }
    }
  }, {
    key: "find",
    ...
    key: "newItem",
    value: function newItem(id, v, options) {
...
function _nearest(node, term) {
  ...
  return [treeTraverser(searchBase,
  //searchBottom(parameters),
  insertBottom, searchInto(parameters, this), function (left, right) {
...
function treeTraverser(base, bottom, into, outof) {
  var self = function self(node) {
    if (base(node)) {
      ...
      return outof.apply(undefined, _toConsumableArray(into(node, self)));
    }
  };
  return self;
}
